...
const GRID_DENSITY_OPTIONS: {
  ...
  // @ts-expect-error - Icon not in strict type list
  { label: 'Compact density', value: 'compact', icon: <Iconify icon="solar:align-vertical-center-bold" width={20} /> },
  // @ts-expect-error - Icon not in strict type list
  { label: 'Standard density', value: 'standard', icon: <Iconify icon="solar:align-horizontal-center-bold" width={20} /> },
  {
    label: 'Comfortable density',
    value: 'comfortable',
    // @ts-expect-error - Icon not in strict type list
    icon: <Iconify icon="solar:align-vertical-center-bold-duotone" width={20} />,
  },
];
  ...
  const renderToggleOption = (
    ...
    return (
      <MenuItem key={key} selected={selected} onClick={() => handleToggleSetting(key)}>
        {selected ? (
          <Iconify icon="solar:eye-bold" width={20} sx={{ mr: 2 }} />
        ) : (
          <Iconify icon="solar:eye-closed-bold" width={20} sx={{ mr: 2 }} />
        )}
        {menuItemLabel}
      </MenuItem>
    );
