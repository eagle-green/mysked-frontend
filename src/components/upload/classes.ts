...
export const uploadClasses = {
  ...
  uploadSinglePreview: createClasses('upload__preview__single'),
  uploadMultiPreview: createClasses('upload__preview__multi'),
  uploadRejectionFiles: createClasses('upload__files__rejected'),
  preview: {
