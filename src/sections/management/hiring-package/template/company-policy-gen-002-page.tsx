...
export function CompanyPolicyGen002Page({ data }: Props) {
  ...
  const employeeSigGen002 = employeePolicySignature(data, 'company_fleet_policies_gen_002');
  ...
  /** Use a row + View for body — nested <Text> inside <Text> breaks @react-pdf/renderer. */
  const BulletList = ({
    content,
    gap = 5,
    bulletSize = 22,
        ...
        >
          ...
          >
            ...
            >
              ...
              >
                {hasPdfImageSrc(employeeSigGen002) ? (
                  <Image
                    src={employeeSigGen002}
                    style={{
                      maxWidth: 70,
                      maxHeight: 70,
                      objectFit: 'contain',
        ...
        >
          ...
          >
            <View style={{ flex: 1, paddingRight: 8 }}>
              <Text style={{ fontFamily: 'Roboto-Bold', fontSize: 12 }}>COMPANY</Text>
            </View>
            <View style={{ flex: 1 }}>
              <Text style={{ fontFamily: 'Roboto-Bold', fontSize: 12 }}>CARD NUMBER</Text>
            </View>
          </View>
          <View
            style={{
          ...
          >
            <View style={{ flex: 1, paddingRight: 8 }}>
              <Text style={{ fontFamily: 'Roboto-Bold', fontSize: 12 }} wrap>
                {String(data.fuel_card?.company_name ?? '')}
              </Text>
            </View>
            <View style={{ flex: 1 }}>
              <Text style={{ fontFamily: 'Roboto-Bold', fontSize: 12 }} wrap>
                {String(data.fuel_card?.card_number ?? '')}
              </Text>
            </View>
          </View>
        </View>
