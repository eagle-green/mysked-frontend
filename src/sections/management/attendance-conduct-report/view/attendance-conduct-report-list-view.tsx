...
const TABLE_HEAD: TableHeadCellProps[] = [
  ...
  { id: 'noShowUnpaid', label: 'No Show\n(Unpaid)', width: 110, align: 'center' },
  { id: 'refusalOfShifts', label: 'Refusal of\nshift', width: 120, align: 'center' },
  { id: 'sentHomeNoPpe', label: 'Sent home\n(No PPE)', width: 140, align: 'center' },
  { id: 'leftEarlyNoNotice', label: 'Left Early\nNo Notice', width: 120, align: 'center' },
  { id: 'lateOnSite', label: 'Late on\nSite', width: 100, align: 'center' },
  { id: 'unapprovedDaysOffShortNotice', label: 'Unapproved\nDays Off', width: 130, align: 'center' },
  { id: 'calledInSick', label: 'Called in\nSick', width: 110, align: 'center' },
  { id: 'unauthorizedDriving', label: 'Unauthorized\nDriving', width: 140, align: 'center' },
  { id: 'drivingInfractions', label: 'Driving\nInfractions', width: 120, align: 'center' },
  { id: 'verbalWarningsWriteUp', label: 'Verbal Warnings\n/ Write Up', width: 140, align: 'center' },
  { id: 'sickLeaveUnpaid', label: 'Sick Leave\n(Unpaid)', width: 120, align: 'center' },
  { id: 'sickLeave5', label: 'Sick Leave\n(5)', width: 100, align: 'center' },
  { id: 'vacationDayUnpaid', label: 'Vacation Day\n(Unpaid)', width: 130, align: 'center' },
  { id: 'vacationDay10', label: 'Vacation Day\n(10)', width: 120, align: 'center' },
  { id: 'personalDayOffUnpaid', label: 'Personal Day\n(Unpaid)', width: 130, align: 'center' },
  { id: 'unapprovePayoutWithoutDayOff', label: 'Unapprove Payout\nwithout Day Off', width: 160, align: 'center' },
