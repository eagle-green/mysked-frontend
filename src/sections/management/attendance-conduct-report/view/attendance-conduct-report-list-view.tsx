...
const TABLE_HEAD: TableHeadCellProps[] = [
  ...
  { id: 'personalUnpaid', label: 'Personal (Unpaid)', width: 120, align: 'center', sortable: false },
  ...
  { id: 'refusalOfShifts', label: 'Refusal of shifts', width: 120, align: 'center', sortable: false },
