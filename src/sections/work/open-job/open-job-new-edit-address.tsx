        ...
        <Stack sx={{ width: 1 }}>
          ...
          {company && company.id ? (
            <Stack spacing={1}>
              ...
              <Typography variant="body2">{company?.fullAddress || ''}</Typography>
        ...
        <Stack sx={{ width: 1 }}>
          ...
          {site && site.id ? (
            <Stack spacing={1}>
              ...
              <Typography variant="body2">{site?.fullAddress || ''}</Typography>
