...
import { JobTableRow } from '../open-job-table-row';
import { JobTableToolbar } from '../open-job-table-toolbar';
import { JobTableFiltersResult } from '../open-job-table-filters-result';
...
export function OpenJobListView() {
