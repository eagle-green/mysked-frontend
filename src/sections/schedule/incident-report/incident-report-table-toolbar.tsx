...
function IncidentReportTableToolbarView({ filters, onResetPage, options, dateError }: Props) {
...
export const IncidentReportTableToolbar = memo(IncidentReportTableToolbarView);
