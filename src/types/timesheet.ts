...
export interface ITimeSheetEntries {
  ...
  travel_time_approved_at?: string | null;
  travel_approved_by_first_name?: string | null;
  travel_approved_by_last_name?: string | null;
  travel_approved_by_photo_url?: string | null;
